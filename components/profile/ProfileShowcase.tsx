...
const SHELF_CLASS = 'group/shelf border-b border-border/70 px-6 py-4';
const SHELF_TITLE_CLASS = 'mb-3 text-2xs font-semibold tracking-wider text-text-primary/55 uppercase';
/**
...
/** Shelf at tile size before the standings arrive, shared with the route's loading state */
export const ProfileShowcaseSkeleton: React.FC = () => (
  <div className={SHELF_CLASS}>
    <h2 className={SHELF_TITLE_CLASS}>Rankings</h2>
    {/* pb-1.5 matches the loaded strip's scrollbar reserve */}
...
export const ProfileShowcase: React.FC<ProfileShowcaseProps> = ({ uid, onStandingsLoaded, activeBuildId, onSelectBuild }) => {
  ...
  if (loading) return <ProfileShowcaseSkeleton />;
