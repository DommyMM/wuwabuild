...
export const CharacterPanel: React.FC<CharacterPanelProps> = ({
  ...
  return (
    <div className="relative w-[30%] shrink-0 self-stretch z-10">
      {/* Glass pane background */}
      <div className="absolute inset-0 bg-white/4 backdrop-blur-[3px] border-r border-white/10 rounded-r-[3rem] shadow-[4px_0_15px_rgba(0,0,0,0.15)] overflow-hidden">
