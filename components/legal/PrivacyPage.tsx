...
import { formatMonthYear, PRIVACY_UPDATED } from '@/lib/legalDates';

export function PrivacyPage() {
    return (
        <main className="max-w-360 mx-auto px-6 py-12">
            <h1 className="font-gowun text-accent text-2xl mb-1">Privacy Policy</h1>
            <p className="text-text-primary/70 text-sm leading-relaxed mb-8">Last updated: {formatMonthYear(PRIVACY_UPDATED)}</p>
