...
import { formatMonthYear, TOS_UPDATED } from '@/lib/legalDates';
...
export function TosPage() {
    return (
        <main className="max-w-360 mx-auto px-6 py-12">
            ...
            <p className="text-text-primary/70 text-sm leading-relaxed mb-8">Last updated: {formatMonthYear(TOS_UPDATED)}</p>
