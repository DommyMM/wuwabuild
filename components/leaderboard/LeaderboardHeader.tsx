...
export const LeaderboardHeader: React.FC<LeaderboardHeaderProps> = ({
  ...
  return (
    <section className="relative overflow-hidden rounded-xl border border-border bg-background-secondary px-5 py-5">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(166,150,98,0.14),transparent_55%)]" />
