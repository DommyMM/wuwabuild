...
interface CardActionBarProps {
  ...
  /** Extra buttons rendered after Download (e.g. "View Ranking"). */
  extraActions?: React.ReactNode;
  /** Outer wrapper className. Defaults assume the bar floats below a card. */
  className?: string;
  /** Inner panel className override (border / rounded corners). */
...
export const CardActionBar: React.FC<CardActionBarProps> = ({
  ...
  panelClassName = 'flex w-full flex-col rounded-lg border border-border bg-background md:w-auto',
}) => {
  return (
      ...
      <div className={panelClassName}>
        <div className="flex flex-wrap items-center gap-2 p-3 md:gap-3">
          ...
          <button
            ...
            className="group relative flex items-center gap-2 overflow-hidden rounded-lg bg-accent px-5 py-2 text-sm font-semibold text-background transition-all duration-300 hover:brightness-110 disabled:cursor-wait disabled:opacity-50"
          >
